...
var MaxNumOfClients = opt.options.maxclient || 10000;
//console.log(MaxNumOfClients);

var LOG = opt.options.LOG || 1;
//console.log(LOG);

function spinSocket (wsport) {

	var wss = new WebSocketServer({port:wsport, host:'0.0.0.0'});

	if (LOG > 0) console.log('WebSocketServer started on ' + wsport + '...');
